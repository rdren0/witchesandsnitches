...
// Component for ASI ability score selection
...
const ASIFeatSelector = ({
  ...
  const availableFeats = standardFeats.filter((feat) =>
...
const CharacterEditor = ({
  ...
  // ASI/Feat related state
  const [asiLevelFilters, setASILevelFilters] = useState({});

  // Helper function to set individual level filters
