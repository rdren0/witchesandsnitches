...
export const INDIVIDUAL_SPELL_MODIFIERS = {
  ...
  "Lux*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Ignis Lunalis*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Lux Maxima*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Trabem*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Stellaro*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Lunativia*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Solativia*": SUBJECT_TO_MODIFIER_MAP.divination,

  "Insectum*": SUBJECT_TO_MODIFIER_MAP.jhc,
  "Beastia Vinculum*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Beastia Amicatum*": SUBJECT_TO_MODIFIER_MAP.charms,
  "Beastia Nuntium R*": SUBJECT_TO_MODIFIER_MAP.charms,
  "Beastia Sensibus R*": SUBJECT_TO_MODIFIER_MAP.divination,
  ...
  "Natura Incantatem R*": SUBJECT_TO_MODIFIER_MAP.divination,
  ...
  "Formidulosus*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Exspiravit*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Fraudemo Maxima*": SUBJECT_TO_MODIFIER_MAP.divination,
  Timor: SUBJECT_TO_MODIFIER_MAP.charms,
  "Relicuum R*": SUBJECT_TO_MODIFIER_MAP.divination,
  "Oculus Malus*": SUBJECT_TO_MODIFIER_MAP.jhc,
  "Menus Eruptus*": SUBJECT_TO_MODIFIER_MAP.divination,
